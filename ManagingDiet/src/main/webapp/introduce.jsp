	...
	<body>
		<div id="menu">
			...
			<main>
				...
				<p>s오늘 하루 고생한 나에게 수고했다며 오늘도 그렇게<br>
					야식으로 <span class="point">1200kcal</span>를 흡입!<br>다음날에는 죄책감에 꼬박 하루를 굶어버리죠.</p>
				<img src="./image/생활.PNG">
				<p>하지만</p>
				<p>회식에, 야근에, 개인공부까지...<br>운동을 생각하는 것 자체가<br>
					말이 안 되는 하루를 살고 계시더라구요.</p>
				<p>저희는 이런 상황에 놓이신 분들에게<br><span class="point">적절한 식단관리</span>를 제공하여 보다 많은 분들이<br>건강하고 행복한 삶을 영위할 수 있기를 바랍니다.</p>
			</main>
