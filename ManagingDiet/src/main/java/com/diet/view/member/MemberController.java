 ...
 * signup(UserVO vo, UserDAOSpring userDAO, RedirectAttributes
 * redirectAttributes) { System.out.println("회원가입 인증 처리...");
 * userDAO.insertMember(vo); redirectAttributes.addFlashAttribute("msg",
 * "REGISTERED"); return "redirect:login.do"; } }
 */